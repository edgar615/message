 ...
 */
public interface VertxConsumerStorage {
   ...
   * @param event
   */
  void isConsumed(Event event, Handler<AsyncResult<Boolean>> resultHandler);
   ...
   */
  void mark(Event event, int result, Handler<AsyncResult<Void>> resultHandler);
}
