...
public interface MessageHeader {
  ...
  MessageHeader addExts(Map<String, String> exts);
   ...
   * @return
   */
  MessageHeader addExt(String name, String value);
   ...
   * @return
   */
  static MessageHeader create(String to, String action) {
   ...
   * @return
   */
  static MessageHeader create(String to, String action, long duration) {
   ...
   * @return
   */
  static MessageHeader create(String id, String to, String action) {
   ...
   * @return
   */
  static MessageHeader create(String id, String to, String action, long duration) {
    return new MessageHeaderImpl(id, to, action, duration);
  }
}
